...
let auto5 = new Automovil("Toyota", "TXL", 100000000, 2023, 20000, "Pitalito-Huila", "img/toyota-ml-1-400x300.jpeg");
let auto4 = new Automovil("Mazda", "3", 22000000, 2019, 50002, "Bogota-D.C.", "img/mazda3-400x300.jpeg");
let auto3 = new Automovil("Toyota", "Fortuner", 210000000, 2023, 20000, "Bogotá-DC", "img/toyota-fortuner-400x300.jpeg");
let auto2 = new Automovil("Mazda", "CX-50", 12000000, 2023, 81600, "Cúcuta - N.S.", "img/mazda-cx50-400x300.jpeg");
let auto1 = new Automovil("Toyota", "Corolla Cross", 15000000, 2024, 93700, "Chía - Cundinamarca", "img/toyota-corolla-cross-400x300.jpeg");
